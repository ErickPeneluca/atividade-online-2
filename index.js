...
let quantidadeDeParticipantes = Math.floor(Math.random() * 110)
let listaDeParticipantes = Math.floor(Math.random() * 100)
let listaDePalestrantes = Math.floor(Math.random() * 4)
...
if (dataDoEvento == "Posterior a data atual")
{
    ...
    console.log("Enquanto a quantidade de participantes for menor igual a 99, permitir cadastro")
        ...
        console.log("Permitido cadastro de participantes")
            ...
            {
            console.log("Não é permitido cadastroo pela idade")
            }
        }
        else
        {
        console.log("Negado cadaastro de participantes, pois o limite foi excedido!")
    }
}
else
{
